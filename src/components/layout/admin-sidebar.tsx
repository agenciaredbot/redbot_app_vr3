...
import { GlassSidebar, type SidebarItem } from "@/components/ui/glass-sidebar";
...
export function AdminSidebar({ orgName }: AdminSidebarProps) {
  return (
    <GlassSidebar
      items={navItems}
      header={
        <Link href="/admin" className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-text-muted">Redbot</p>
          </div>
        </Link>
      }
    />
